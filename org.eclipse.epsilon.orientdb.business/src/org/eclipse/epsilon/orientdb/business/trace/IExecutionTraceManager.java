...
public interface IExecutionTraceManager {
	 ...
	 */
	public void setExecutionContext(String scriptId, List<String> models) throws IncrementalExecutionException;
	 ...
	 * @throws EOLIncrementalExecutionException 
	 */
	public List<Trace> findExecutionTraces(String objectId, String propertyName) throws IncrementalExecutionException;
	 ...
	 */
	public List<Trace> findExecutionTraces(String objectId) throws IncrementalExecutionException;
